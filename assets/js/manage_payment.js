...
function payNow(upi_address,upi2,upi3) {
    ...
    switch (payType) {
        ...
        case 'paytm':
            redirect_url = "paytmmp://pay?pa=" + upi2 + "&pn=" + site_name + "&am=" + amt + "&cu=INR&tn=" + site_name;
            break;

        case 'bhim_upi':
            redirect_url = "upi://pay?pa=" + upi3 + "&pn=" + site_name + "&am=" + amt + "&cu=INR&tn=" + site_name;
            break;

        case 'whatspp_pay':
            redirect_url = "whatsapp://pay?pa=" + upi_address + "&pn=" + site_name + "&am=" + amt + "&cu=INR&tn=" + site_name;
            break;
